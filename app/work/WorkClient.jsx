      ...
      <div className="relative container mx-auto px-4 pt-24">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-white/60 text-lg max-w-2xl mx-auto">
            A showcase of real-world solutions, from scalable web applications to enterprise DevOps implementations
          </p>
        </div>
        ...
        {(category === 'devops' || category === 'cloud') && (
          <div className="mt-16 bg-[#1A2333]/50 border border-accent/20 rounded-xl p-8 text-center">
            <h2 className="text-2xl font-bold text-white mb-4">Need Professional {category === 'devops' ? 'DevOps' : 'Cloud'} Services?</h2>

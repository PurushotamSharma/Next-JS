                    ...
                    {!showSuccess ? (
                        <>
                            {step === 1 && (
                                <div className="space-y-6">
                                    <div className="text-center mb-8">
                                        <h1 className="text-3xl font-bold mb-2 text-white">Your Information</h1>
                            ...
                            {step === 2 && (
                                <div className="space-y-6">
                                    <div className="text-center mb-8">
                                        <h1 className="text-3xl font-bold mb-2 text-white">Choose Date & Time</h1>
                            ...
                            {step === 3 && (
                                <div className="space-y-6">
                                    <div className="text-center mb-8">
                                        <h1 className="text-3xl font-bold mb-2 text-white">Confirm Details</h1>
